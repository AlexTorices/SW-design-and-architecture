...
class ControlTest < Minitest::Test
  ...
  # Tests the light switch, as well as the remote control assignment of the buttons.
  # Turns on and off the light and undoes some actions.
  def test_light
  ...
  # Tests the ceiling fan, as well as the remote control assignment of the buttons.
  # Changes the fan speed and undoes some actions.
  def test_fan
