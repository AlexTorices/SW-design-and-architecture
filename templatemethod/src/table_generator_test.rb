...
class TableGeneratorTest < Minitest::Test
    ...
    # Prepares all instances for the unit tests.
  ...
  def setup
    ...
    # Tests CSVTableGenerator
    # Creates CSVTableGeneratorInstances
  def test_CSVTableGenerator
    ...
    # Tests HTMLTableGenerator
    # Creates HTMLTableGeneratorInstances
  def test_HTMLTableGenerator
    ...
    # Tests AsciiDocTableGenerator
    # Creates AsciiDocTableGenerator
